                    ...
                    ? (o(),
                      de(
                        L,
                        {
                          ...
                          size: "large",
                          color:
                            "linear-gradient(180deg, #D9AD82 0%, #B1835A 100%)",
                          onClick: a(f),
                        },
                        {
                          icon: P(() => [
