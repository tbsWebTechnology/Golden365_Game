...
function reload_money() {
  fetch("/api/webapi/GetUserInfo").then(function (response) {
    ...
    $(".num span").text("\u20B9 ".concat(data.data.money_user, " "));
    $('.Loading').fadeOut(0);
  });
}
reload_money();
