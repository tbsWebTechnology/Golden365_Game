...
var addK3 = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(game) {
    var join, _yield$connection$que21, _yield$connection$que22, k3, isPendingGame, result2, _yield$connection$que23, _yield$connection$que24, setting, period, nextResult, newArr, result, arr, check, i, timeNow, gameRepresentationId, NewGamePeriod;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 8:
          ...
          k3 = _yield$connection$que22[0];
          isPendingGame = k3.length > 0;
          if (!isPendingGame) {
            _context5.next = 45;
            break;
          }
          result2 = makeGameResult(3);
          _context5.next = 16;
        ...
        case 39:
          ...
          if (game == 10) join = "k3d10";
          _context5.next = 45;
          return _connectDB["default"].execute("UPDATE admin_ac SET ".concat(join, " = ?"), [newArr]);
        case 45:
          timeNow = Date.now();
          gameRepresentationId = _game_representation_id["default"].G5D[game];
          NewGamePeriod = (0, _games.generatePeriod)(gameRepresentationId);
          _context5.next = 50;
          return _connectDB["default"].execute("\n         INSERT INTO k3\n         SET period = ".concat(NewGamePeriod, ", result = 0, game = '").concat(game, "', status = 0, time = ").concat(timeNow, "\n      "));
        case 50:
          _context5.next = 55;
          break;
        case 52:
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        ...
        case 2:
          ...
          k3 = _yield$connection$que40[0];
          k3Info = k3[0]; // update ket qua
          _context9.next = 8;
          return _connectDB["default"].execute("UPDATE result_k3 SET result = ? WHERE status = 0 AND game = ".concat(game), [k3Info.result]);
        case 8:
          result = String(k3Info.result).split("");
          total = 0;
        ...
        case 65:
          ...
          _kq = String(k3Info.result).split("");
          _kq2 = _kq[0] + _kq[1];
          _kq3 = _kq[1] + _kq[2];
        ...
        case 77:
          ...
          _kq4 = String(k3Info.result).split("");
          _kq5 = _kq4[0] + _kq4[1];
          _kq6 = _kq4[1] + _kq4[2];
          kq3 = _kq4[0];
          kq4 = _kq4[2];
        ...
        case 158:
          ...
          _kq10 = String(k3Info.result).split("");
          _check5 = false;
          _check6 = false;
          _check7 = false;
        ...
        case 179:
          ...
          _kq14 = String(k3Info.result).split("");
          _check8 = false;
          _check9 = false;
        ...
        case 192:
          ...
          _kq15 = String(k3Info.result).split("");
          _check10 = false;
          _check11 = false;
        ...
        case 208:
          ...
          _kq19 = String(k3Info.result).split("");
          _check12 = false;
          _check13 = false;
        ...
        case 224:
          ...
          _kq23 = String(k3Info.result).split("");
          _check14 = false;
        ...
        case 235:
          ...
          _kq24 = String(k3Info.result).split("");
          _check15 = false;
        ...
        case 249:
          ...
          _kq28 = String(k3Info.result).split("");
          _check16 = false;
...
var listOrderOld = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var _req$body2, gameJoin, pageno, pageto, auth, checkGame, _yield$connection$que25, _yield$connection$que26, user, game, _yield$connection$que27, _yield$connection$que28, k3, _yield$connection$que29, _yield$connection$que30, k3All, _yield$connection$que31, _yield$connection$que32, period, page;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 18:
          ...
          k3All = _yield$connection$que30[0];
          _context7.next = 23;
          return _connectDB["default"].query("SELECT period FROM k3 WHERE status = 0 AND game = '".concat(game, "' ORDER BY id DESC LIMIT 1 "));
        case 23:
        ...
        case 30:
          page = Math.ceil(k3All.length / 10);
          return _context7.abrupt("return", res.status(200).json({
            code: 0,
            msg: "Get success",
            data: {
...
var _default = exports["default"] = k3Controller;