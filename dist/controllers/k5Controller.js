...
var add5D = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(game) {
    var join, _yield$connection$que35, _yield$connection$que36, k5D, isPendingGame, result2, _yield$connection$que37, _yield$connection$que38, setting, period, nextResult, newArr, result, arr, check, i, timeNow, gameRepresentationId, NewGamePeriod;
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        ...
        case 8:
          ...
          isPendingGame = k5D.length > 0;
          if (!isPendingGame) {
            _context10.next = 45;
            break;
          }
          result2 = makeGameResult(5);
          _context10.next = 16;
...
var _default = exports["default"] = k5Controller;