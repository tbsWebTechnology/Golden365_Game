    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          _context.next = 8;
          return _connectDB["default"].execute(sql, ["2022070110000", arr[i], timeNow]);
        case 8:
          sql_1 = "INSERT INTO wingo SET period = ?, game = ?, amount = 0, status = 0, time = ?";
          _context.next = 11;
          return _connectDB["default"].execute(sql_1, ["2022070110001", arr[i], timeNow]);
        case 11:
          i++;
          _context.next = 4;
          break;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          _context2.next = 8;
          return _connectDB["default"].execute(sql, ["2022070110000", "23521", arr[i], timeNow]);
        case 8:
          sql_1 = "INSERT INTO 5d SET period = ?, result = ?, game = ?, status = 0, time = ?";
          _context2.next = 11;
          return _connectDB["default"].execute(sql_1, ["2022070110001", "0", arr[i], timeNow]);
        case 11:
          i++;
          _context2.next = 4;
          break;
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          ...
          _context3.next = 8;
          return _connectDB["default"].execute(sql, ["2022070110000", "235", arr[i], timeNow]);
        case 8:
  ...
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _context6.next = 2;
          return _connectDB["default"].execute("DELETE FROM admin_ac");
        case 2:
          _context6.next = 4;
          return _connectDB["default"].execute("INSERT INTO `admin_ac` (`id`, `wingo1`, `wingo3`, `wingo5`, `wingo10`, `k5d`, `k5d3`, `k5d5`, `k5d10`, `win_rate`, `telegram`, `cskh`, `app`) VALUES (NULL, '-1', '-1', '-1', '-1', '-1', '-1', '-1', '-1', '80', 'https://t.me/Olivia_XDR', 'https://t.me/Olivia_XDR', '#')");
        case 4:
        case "end":
